...
{
    ITEM_MENU_ACTION_USE,
    ITEM_MENU_ACTION_TOSS,
    ITEM_MENU_ACTION_REGISTER,
    ITEM_MENU_ACTION_GIVE,
    ITEM_MENU_ACTION_CANCEL,
    ITEM_MENU_ACTION_USE_IN_BATTLE,
    ITEM_MENU_ACTION_CHECK,
    ITEM_MENU_ACTION_WALK,
    ITEM_MENU_ACTION_DESELECT,
    ITEM_MENU_ACTION_CHECK_TAG,
    ITEM_MENU_ACTION_CONFIRM,
    ITEM_MENU_ACTION_SHOW,
    ITEM_MENU_ACTION_GIVE_2,
    ITEM_MENU_ACTION_CONFIRM_2,
    ITEM_MENU_ACTION_BY_NAME,
    ITEM_MENU_ACTION_BY_TYPE,
    ITEM_MENU_ACTION_BY_AMOUNT,
    ITEM_MENU_ACTION_COUNT,
};
...
const struct MenuAction sItemMenuActions[] = {
    [ITEM_MENU_ACTION_USE] = {gMenuText_Use, ItemMenu_UseOutOfBattle},
    [ITEM_MENU_ACTION_TOSS] = {gMenuText_Toss, ItemMenu_Toss},
    [ITEM_MENU_ACTION_REGISTER] = {gMenuText_Register, ItemMenu_Register},
    [ITEM_MENU_ACTION_GIVE] = {gMenuText_Give, ItemMenu_Give},
    [ITEM_MENU_ACTION_CANCEL] = {gText_Cancel2, ItemMenu_Cancel},
    [ITEM_MENU_ACTION_USE_IN_BATTLE] = {gMenuText_Use, ItemMenu_UseInBattle},
    [ITEM_MENU_ACTION_CHECK] = {gMenuText_Check, ItemMenu_UseOutOfBattle},
    [ITEM_MENU_ACTION_WALK] = {gMenuText_Walk, ItemMenu_UseOutOfBattle},
    [ITEM_MENU_ACTION_DESELECT] = {gMenuText_Deselect, ItemMenu_Register},
    [ITEM_MENU_ACTION_CHECK_TAG] = {gMenuText_CheckTag, ItemMenu_CheckTag},
    [ITEM_MENU_ACTION_CONFIRM] = {gMenuText_Confirm, unknown_ItemMenu_Confirm},
    [ITEM_MENU_ACTION_SHOW] = {gMenuText_Show, unknown_ItemMenu_Show},
    [ITEM_MENU_ACTION_GIVE_2] = {gMenuText_Give2, unknown_ItemMenu_Give2},
    [ITEM_MENU_ACTION_CONFIRM_2] = {gMenuText_Confirm, unknown_ItemMenu_Confirm2},
    [ITEM_MENU_ACTION_BY_NAME] = {sMenuText_ByName, ItemMenu_SortByName},
    [ITEM_MENU_ACTION_BY_TYPE] = {sMenuText_ByType, ItemMenu_SortByType},
    [ITEM_MENU_ACTION_BY_AMOUNT] = {sMenuText_ByAmount, ItemMenu_SortByAmount},
    [ITEM_MENU_ACTION_COUNT] = {gText_EmptyString2, NULL}
};
...
bool8 sub_81ACDFC(s8 a)
{
    ...
    if (a > gBagMenu->unk828)
        return FALSE;
    if (gBagMenu->unk820[a] == ITEM_MENU_ACTION_COUNT)
        return FALSE;
    return TRUE;
}
